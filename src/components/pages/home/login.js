...
export default function (props) {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            {(errors.userName || errors.userName) && <div className="serverError"> name and password is required</div>}
            ...
            <div>
                <input
                    ...
                    name="userName"
                    className={classnames("auth_input", {"auth_input-error": errors.userName})}
                    ref={register({
                        required: true,
                    })}
                ...
                <input
                    ...
                    name="password"
                    className={classnames("auth_input password", {"auth_input-error": errors.userName})}
                    ref={register({
                        minLength: 4,
                        required: true,
                    })}
            ...
            <button disabled={loading}>
                {loading && <img src="https://www.voya.ie/Interface/Icons/LoadingBasketContents.gif" />}
                log in
            </button>
        </form>
    );
